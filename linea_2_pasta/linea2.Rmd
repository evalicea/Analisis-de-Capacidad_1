---
title: "Análisis de Línea 2 de producción de Pastas"
...
Análisis de capacidad de producción del contenido en paquetes de pasta de la línea 2 de la empresa FIDEOS & PASTAS.

La línea 2, produce pastas de 200 g y se quiere certificar su proceso de envasado. El valor nominal es de 200g, la Especificación superior 208g y la Especificación inferior de 198g.
...
Creamos un vector con todos los datos de los subgrupos de la línea 2

```{r message=FALSE, warning=FALSE}
attach(linea2)
vlinea2 = c(x1, x2, x3, x4, x5)
vlinea2
```
...
plot(x,y, ylab = "Densidad", type = "l", col = "black", 
     main="Prueba de hipotesis bilateral Linea 2")
